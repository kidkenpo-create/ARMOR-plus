...
ISSUE_RULES: tuple[IssueRule, ...] = (
    IssueRule(
        ...
        route_first=("FAR 8.1100", "FAR 8.1102"),
        classroom_reference="FAR 8.1100",
        current_reference="FAR 8.1100",
        scope_gate="FAR 8.1100",
        reject_as_controlling=("DFARS 207.401",),
        notes=(
            "This is a motor-vehicle certification issue, not a lease-or-purchase justification issue.",
            "Check the FAR 8.11 scope gate before the certification rule.",
        ),
    ),
    IssueRule(
        ...
        route_first=("FAR 25.100(b)(1)", "FAR 25.102", "FAR 25.103", "FAR 2.101"),
        classroom_reference="FAR 25.100(b)(1)",
        current_reference="RFO FAR 25.100(b)(1)",
        scope_gate="FAR 25.100(b)(1)",
        reject_as_controlling=("FAR 25.102", "FAR 25.003"),
        notes=(
    ...
    IssueRule(
        ...
        route_first=("FAR 17.108(b)", "DFARS 217.170(d)(1)(iv)", "RFO FAR 17.104-3"),
    ...
    IssueRule(
        ...
        route_first=("FAR 2.101", "FAR 1.107(c)"),
    ...
    IssueRule(
        ...
        route_first=("DFARS PGI 236.203(1)", "FAR 36.203", "DFARS 236.203"),
        classroom_reference="DFARS PGI 236.203(1)",
        current_reference="DFARS PGI 236.203(1)",
        notes=("Handling/marking of DoD construction estimates routes to PGI, not only FAR 36.203.",),
    ),
    IssueRule(
        ...
        route_first=("FAR 1.108(b)", "FAR 17.106-3(g)"),
        classroom_reference="FAR 1.108(b)",
        current_reference="FAR 1.108(b)",
    ...
    IssueRule(
        ...
        route_first=("DFARS 212.102(a)(iii)(A)", "DFARS 212.102(a)(i)(A)"),
        classroom_reference="DFARS 212.102(a)(i)(A) or DFARS 212.102(a)(iii)(A)",
        current_reference="DFARS 212.102(a)(iii)(A)",
        notes=("If FAR part 12 use is under the commerciality path and exceeds SAT, written determination is required.",),
    ),
    IssueRule(
        ...
        route_first=("DFARS 237.173-4", "DFARS 237.173-3(a)", "DFARS 237.173-2"),
        classroom_reference="DFARS 237.173-4",
        current_reference="DFARS 237.173-4",
    ...
    IssueRule(
        ...
        route_first=("FAR 27.400", "DFARS 227.400", "FAR 27.409(b)(1)"),
        classroom_reference="FAR 27.400 or DFARS 227.400",
        current_reference="FAR 27.400 or DFARS 227.400",
        scope_gate="FAR 27.400",
        reject_as_controlling=("FAR 27.409(b)(1)",),
        notes=(
            "In classroom mode, DoD is assumed; do not treat DoD status as unknown.",
            "For DoD, FAR 27.400/DFARS 227.400 controls before the FAR 52.227-14 prescription.",
            "Expected classroom answer is No when the question asks whether FAR 52.227-14 is required for DoD technical data.",
        ),
    ),
    IssueRule(
        ...
        route_first=("DFARS 217.7404-5(a)", "DFARS 217.7404-4"),
        classroom_reference="DFARS 217.7404-5(a)",
        current_reference="DFARS 217.7404-5(a)",
        reject_as_controlling=("DFARS 217.7404-4",),
    ...
    IssueRule(
        ...
        route_first=("DFARS 246.710(2)", "FAR 46.710(e)(1)"),
        classroom_reference="DFARS 246.710(2)",
        current_reference="DFARS 246.710(2)",
        reject_as_controlling=("FAR 46.710(e)(1)", "FAR 52.246-21"),
    ...
    IssueRule(
        ...
        route_first=("CD 2017-O0004", "DFARS 225.371-5(a)"),
        classroom_reference="CD 2017-O0004",
        current_reference="CD 2017-O0004",
        reject_as_controlling=("DFARS 225.371-5(a)",),
    ...
    IssueRule(
        ...
        route_first=("DFARS 237.102-71(b)", "PGI 237.102-71"),
        classroom_reference="DFARS 237.102-71(b)",
        current_reference="DFARS 237.102-71(b)",
    ...
    IssueRule(
        ...
        route_first=("FAR 19.703(a)(2)(i)",),
        classroom_reference="FAR 19.703(a)(2)(i)",
        current_reference="FAR 19.703(a)(2)(i)",
    ...
    IssueRule(
        ...
        route_first=("DFARS 232.803(b)", "FAR 32.803(b)"),
        classroom_reference="DFARS 232.803(b)",
        current_reference="DFARS 232.803(b)",
        reject_as_controlling=("FAR 32.803(b)",),
        notes=("For DoD, DFARS 232.803(b) is the expected controlling authority, not the broader FAR cite.",),
    ),
    IssueRule(
        ...
        route_first=("FAR 9.102(b)(3)", "FAR 9.103(b)"),
        classroom_reference="FAR 9.102(b)(3)",
        current_reference="FAR 9.102(b)(3)",
        reject_as_controlling=("FAR 9.103(b)",),
...
def _source_family_for_citation(citation: str) -> str:
    if citation.startswith("DFARS"):
        return "legacy"
    if citation.startswith("FAR"):
        return "legacy"
    if citation.startswith("RFO FAR"):
        return "rfo_far"
    return "unknown"
